...
annotations_A = pd.read_csv(
    start.CLEAN_DIR + "annotations/validation_relevance_batch2_annnotated_KLA.csv",
    encoding="utf-8",
)
annotations_A["annotator"] = "A"

annotations_B = pd.read_csv(
    start.CLEAN_DIR + "annotations/validation_relevance_batch2_annotated_JG.csv"
)
...
print(f"Of those we agreed {agreement_either.round(3)} percent of the time")
