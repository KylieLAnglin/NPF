...
clf = pipeline.fit(training.text, training_outcome)
...
precisions, recalls, thresholds = precision_recall_curve(
    training_outcome, clf.decision_function(training.text)
)
...
precisions, recalls, thresholds = precision_recall_curve(training_outcome, probas)
...
cf_matrix = confusion_matrix(testing_outcome, testing.classification_ridge)
...
cf_matrix = confusion_matrix(testing_outcome, testing.classification_ridge_recall)
classify.create_plot_confusion_matrix(cf_matrix=cf_matrix)


roc_auc_score(testing_outcome, [proba[1] for proba in clf.predict_proba(testing.text)])
