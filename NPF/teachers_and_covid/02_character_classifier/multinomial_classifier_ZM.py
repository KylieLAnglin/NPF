...
DATA_DIR = "/Users/kla21002/Library/CloudStorage/GoogleDrive-kylie.anglin@uconn.edu/.shortcut-targets-by-id/1wL0tiiBznVSn5Gij9hYTiC6HTPCExAn8/Policy Narratives and NLP/Data and Code/NLP/data/"
CLEAN_DIR = DATA_DIR + "clean/"
# %%
annotations = pd.read_csv(CLEAN_DIR + "annotations_ZM.csv", index_col="unique_id")
...
liwc = pd.read_csv(CLEAN_DIR + "liwc.csv")
liwc["unique_id"] = liwc.unique_id.astype(int)
liwc = liwc.set_index("unique_id")

matrix = pd.read_csv(CLEAN_DIR + "matrix_annotations_small.csv", index_col="unique_id")
...
scores.to_csv(CLEAN_DIR + "multinomial_scores_liwc.csv")
